...
export class Card {
    ...
    render() {
        ...
        // Agregar categoría y sección si existen
        if (this.contact.category || this.contact.section) {
            ...
            if (this.contact.category) {
                ...
                categoryTag.textContent = this.contact.category;
                tags.appendChild(categoryTag);
            }
            
            if (this.contact.section) {
                const sectionTag = document.createElement('span');
                sectionTag.className = 'tag section';
                sectionTag.textContent = this.contact.section;
                tags.appendChild(sectionTag);
            }
