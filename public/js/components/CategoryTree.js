    ...
    setupEventListeners() {
        ...
        categoryItems.forEach(item => {
            ...
            item.addEventListener('click', (event) => {
                ...
                const hasSubcategories = subList && 
                    (subList.classList.contains('subcategory-list') || 
                     subList.querySelectorAll('.subcategory-list').length > 0);

                // Si tiene subcategorías, solo expandir/colapsar la lista
                if (hasSubcategories) {
                    ...
                    return; // No continuar con la selección de contactos
                }
